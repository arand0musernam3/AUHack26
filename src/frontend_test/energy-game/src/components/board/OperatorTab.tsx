...
export const OperatorTab: React.FC<OperatorTabProps> = ({ 
  ...
  return (
    <div className="tab-content" style={{ padding: '20px', display: 'flex', flexDirection: 'column', height: '100%' }}>
      {/* Local Player Stats */}
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div className="action-cards-grid" style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '10px', overflowY: 'auto' }}>
